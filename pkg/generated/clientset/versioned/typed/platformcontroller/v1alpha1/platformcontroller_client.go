...
import (
	...
	"k8s.io/platform-controller/pkg/generated/clientset/versioned/scheme"
)

type SamplecontrollerV1alpha1Interface interface {
	RESTClient() rest.Interface
	PlatformWorkloadsGetter
}

// SamplecontrollerV1alpha1Client is used to interact with features provided by the platformcontroller.k8s.io group.
type SamplecontrollerV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SamplecontrollerV1alpha1Client) PlatformWorkloads(namespace string) PlatformWorkloadInterface {
	return newPlatformWorkloads(c, namespace)
}
